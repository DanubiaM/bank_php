...
$app->get('/balance/$idAccount', function ($req, $res, $args) {return Controller::instance( $this->get(UseCase::class))->balance($req, $res,$args);});
$app->post('/transaction', function ($req, $res, $args) {return Controller::instance($this->get(UseCase::class))->transaction($req, $res,$args);});
